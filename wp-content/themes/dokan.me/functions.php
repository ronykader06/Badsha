...
function lpd_enqueue_scripts() {
    ...
    wp_register_script('dokan-jrumble', THEME_ASSETS.'js/jquery.jrumble.1.3.js', false, false, true);
    wp_register_script('dokan-cart-animate', THEME_ASSETS.'js/jquery.animate_from_to-1.0.js', false, false, true);
	...
	wp_enqueue_script('dokan-jrumble');
	wp_enqueue_script('dokan-cart-animate');
...
/* will be removed in version 1.2 function lpd_ie_style() {
...
// add_action( 'woocommerce_sidebar', 'load_custom_sidebar', 11 );

// function load_custom_sidebar() {
// 	echo "hello";
// }
