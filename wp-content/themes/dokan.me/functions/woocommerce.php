	...
	ob_start();?>
		...
		<div class="header-cart">
			<a class="header-cart-button" href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
				...
				<span class="cart-total"><?php _e('Cart', GETTEXT_DOMAIN); ?> - <?php echo $woocommerce->cart->get_cart_subtotal(); ?> <span class="glyphicons down_arrow glyphicons-icon"></span> </span>
			</a>
